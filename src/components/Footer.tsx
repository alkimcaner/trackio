...
export default function Footer() {
  return (
    <footer className="sticky top-0 z-20 mt-auto w-full border-t bg-background text-xs">
      <div className="mx-auto flex max-w-7xl flex-col justify-center gap-2 px-8 py-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          Copyright © {new Date().getFullYear()} Alkım Caner Soydan. All rights
          reserved.
        </div>
